export default function GenresPage() {
   ...
   return(
    <div  className="flex flex-col min-h-screen justify-center items-center p-6 gap-6">   
     ...
     <div className="flex gap-4 text-xs text-center">   
         <div className="w-40 h-40 p-4 bg-primary"> 
           Background Primary
         </div>
        ...
        <div className="w-40 h-40 relative bg-accent">
        Named Colors
        </div>
  ...
  return(
      ...
      <div className="flex bg-amber-200 min-h-screen justify-center items-center p-6">
         {/* class container */}
  ...
  // Example 01- flex-box
    <div className=" flex flex-col md:flex-row items-center justify-center bg-purple-300 min-h-screen p-6 gap-5">
        <div className="h-20 w-30 p-6 bg-green-200 rounded text-center"> Div 01</div>
        <div className="h-20 w-30 p-6 bg-red-200 rounded text-center"> Div 02</div>
        <div className="h-20 w-30 p-6 bg-orange-200 rounded text-center"> Div 03</div>
        <div className="h-20 w-30 p-6 bg-yellow-200 rounded text-center"> Div 04</div>
